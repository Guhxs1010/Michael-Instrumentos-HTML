...
<body>
    ...
    <div class="video-inicio">
        <video src="videos/Baixo-Banner.mp4" class="video-baixo" autoplay loop muted></video>
    </div>
                  ...
                  <div class="wrapper">
                      <div class="card">
                        ...
                        <div class="right">
                          <h2>BAIXO</h2>
                          <ul>
                            <li class="lii">BM607N</li>
                            <li class="lii">SK (SUNBURST BLACK)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/baixo-1.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                  ...
                  <div class="wrapper">
                      <div class="card">
                        ...
                        <div class="right">
                          <h2>BAIXO</h2>
                          <ul>
                            <li class="lii">BMJ500</li>
                            <li class="lii">05 CORDAS</li>
                            <li class="lii">CR (CREAM)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/BAIXO-4.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                    ...
                    <div class="wrapper">
                      <div class="card">
                        ...
                        <div class="right">
                          <h2>BAIXO</h2>
                          <ul>
                            <li class="lii">BM516N</li>
                            <li class="lii">06 CORDAS</li>
...
function buscarProduto() {
    ...
    const videoGuita = document.querySelector(".video-baixo");
