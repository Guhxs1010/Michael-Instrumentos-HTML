...
<ul class="nav-cont" id="produtos-container">
    ...
    <div class="meio">
        ...
        <div class="texto-meio">
            <h1 class="texto-centro">Sobre a PowerGate</h1>
            <p class="conteudo-centro">Power Gate é uma combinação que harmoniza perfeitamente no mundo da música. A Michael Instrumentos é conhecida por seu compromisso com a qualidade e a inovação no desenvolvimento de instrumentos musicais, enquanto a Power Gate se destaca por sua excelência na fabricação e venda de caixas de bateria. Juntas, essas empresas oferecem aos músicos uma gama de produtos que elevam o desempenho e a experiência musical.</p>
        </div>
        <div class="imagem-meio">
            <img class="imagem-centro" src="img/power.png" alt="">
        ...
        <div class="wrapper">
            <div class="card">
              ...
              <div class="right">
                <h2>CAIXA</h2>
                <ul>
                  <li class="lii">BIRCH</li>
                  <li class="lii">PGB1255</li>
                  <li class="lii">FRD</li>
                  <li class="lii">12x5,5 </li>
                </ul>
          ...
          <div class="wrapper">
            <div class="card">
              ...
              <div class="right">
                <h2>CAIXA</h2>
                <ul>
                  <li class="lii">PGM1455</li>
                  <li class="lii">NTS</li>
                  <li class="lii">14x5,5</li>
                </ul>
                <button class="comprar">Comprar</button>
              </div>
            </div>
            <div class="img-wrapper">
                 <img src='img/caixa-3.png' alt=''>    
            </div>
          </div> 
        </div>
        </div>
          ...
          <div class="wrapper">
            <div class="card">
              ...
              <div class="right">
                <h2>CAIXA</h2>
                <ul>
                  <li class="lii">PGS0806</li>
                  <li class="lii">JBK</li>
                  <li class="lii">08x06</li>
                </ul>
                <button class="comprar">Comprar</button>
              </div>
            </div>
            <div class="img-wrapper">
                 <img src='img/caixa-5.png' alt=''>    
            </div>
          </div> 
        </div>
          ...
          <div class="wrapper">
            <div class="card">
              ...
              <div class="right">
                <h2>CAIXA</h2>
                <ul>
                  <li class="lii">PGS1408</li>
                  <li class="lii">JBK</li>
                  <li class="lii">14x08</li>
                </ul>
                <button class="comprar">Comprar</button>
              </div>
            </div>
            <div class="img-wrapper">
                 <img src='img/caixa-6.png' alt=''>    
            </div>
          </div> 
        </div>
        </div>
...
function buscarProduto(){
            ...
            const produto = document.getElementsByClassName("wrapper")

            for(let i = 0; i<produto.length; i++){
                const produtoNome = produto[i].querySelector("h1").innerText.toLowerCase()
    ...
    const videoGuita = document.querySelector(".power");
    const videoGuita2 = document.querySelector(".meio");
