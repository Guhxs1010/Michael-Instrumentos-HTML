...
<body>
    ...
    <div class="video-inicio">
        <video class="video-bateria" src="videos/bateria-banner.mp4" autoplay loop muted></video>
    </div>
              ...
              <div class="container-caixas">
                ...
                <div class="caixa-1">
                  <div class="wrapper">
                      <div class="card">
                        <div class="front">
                          <h1>BATERIA MICHAEL LEGACY</h1>
                          <p>Michael</p>
                          <p class="price">R$ 7000.00</p>
                        </div>
                        <div class="right">
                          <h2>BATERIA</h2>
                          <ul>
                            <li class="lii">BIRCH</li>
                            <li class="lii">DMB522 </li>
                            <li class="lii">BUMBO 22</li>
                            <li class="lii"> (SHELL PACK)</li>
                            <li class="lii"> SHG (SHINING GOLD)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/bateria-1.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                    ...
                    <div class="wrapper">
                      <div class="card">
                        ...
                        <div class="right">
                          ...
                          <ul>
                            <li class="lii">BIRCH</li>
                            <li class="lii">DMB520</li>
                            <li class="lii">BUMBO 20</li>
                            <li class="lii">(SHELL PACK)</li>
                            <li class="lii">BRG (BRIGHT GREY)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/BATERIA-2.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                  ...
                  <div class="caixa-3">
                    <div class="wrapper">
                      <div class="card">
                        <div class="front">
                          <h1>BATERIA MICHAEL EVOLVE</h1>
                          <p>Michael</p>
                          <p class="price">R$ 6000.00</p>
                        </div>
                        <div class="right">
                          <h2>BATERIA</h2>
                          <ul>
                            <li class="lii">DME622</li>
                            <li class="lii">BUMBO 22</li>
                            <li class="lii">(SHELL PACK)</li>
                            <li class="lii">LCM (LACQUER CARAMEL)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/bateria-3.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                  </div>
                ...
                <div class="caixa-4">
                  <div class="wrapper">
                      <div class="card">
                        <div class="front">
                          <h1>BATERIA MICHAEL LEGACY</h1>
                          <p>Michael</p>
                          <p class="price">R$ 3000.00</p>
                        </div>
                        <div class="right">
                          <h2>CAIXA</h2>
                          <ul>
                            <li class="lii">DML420</li>
                            <li class="lii">BUMBO 20</li>
                            <li class="lii">SMB (SPARKLE MARINE BLUE)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/bateria-4.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                    ...
                    <div class="wrapper">
                      <div class="card">
                        ...
                        <div class="right">
                          <h2>BATERIA</h2>
                          <ul>
                            <li class="lii">DML422</li>
                            <li class="lii">BUMBO 22</li>
                            <li class="lii">SSR (SPARKLE SILVER)</li>
                          </ul>
                          <button class="comprar">Comprar</button>
                        </div>
                      </div>
                      <div class="img-wrapper">
                           <img src='img/bateria-5.png' alt=''>    
                      </div>
                    </div> 
                  </div>
                  ...
                  <div class="caixa-6">
                    <div class="wrapper">
                      <div class="card">
                        <div class="front">
                          <h1>BATERIA MICHAEL TRINITY</h1>
                          <p>Michael</p>
                          <p class="price">R$ 3500.00</p>
                        </div>
                        <div class="right">
                          <h2>BATERIA</h2>
                          <ul>
                            <li class="lii">DMT218</li>
                            <li class="lii">BUMBO 18</li>
...
function buscarProduto() {
    ...
    const videoGuita = document.querySelector(".video-bateria");
