...
.container {
 ...
 /* Estilo do menu de produtos */
       #produtos-container {
        ...
        .meio{
            background-image: url(img/fundo-menino.png);
        ...
        .ensino-basico-crianca{
            background-image: url(img/fundo.png);
                background-size: cover;
                background-position: top; 
        }
        .texto-centro, .texto-centro2{
                color: #ffff;
                font-family: 'Font';
                font-size: 30px;
                width: 500px;
        }
        .texto-ensino, .texto-ensino2{
            color: #ffff;
                font-family: 'Font';
                font-size: 30px;
                width: 500px;
        }
        .texto-ensino-basico,.texto-ensino-basico2{
            color:#5F489;
                font-family: 'Font';
                font-size: 30px;
                width: 500px;
        } 
        .conteudo-centro, .conteudo-centro2{
                color: #ffffff;
                font-family: 'Font';
                font-size: 19px;
                width: 600px;
        ...
        .conteudo-centro
        .conteudo-ensino, .conteudo-ensino2{
            color: #fff;
                font-family: 'Font';
                font-size: 19px;
                width: 600px;
...
.Btn:active {
  ...
  transition-duration: .3s;
        ...
        padding: 20px;
        text-align: center;
        max-width: 600px; /* Aumentei a largura para 600px para torná-la maior */
        margin: 0 auto;
        margin-top: -80px;
    }
    ...
    .form {
        border-radius: 10px;
        padding: 20px; /* Adicionei um preenchimento para melhorar a aparência */
        margin-top: 20px; /* Adicionei um espaçamento superior para separar do parágrafo acima */
    }

    .caixa-contribuir form {
        margin-top: 20px;
    }

    .caixa-contribuir label {
        display: block;
        font-size: 18px;
        color: #fff;
    }

    .caixa-contribuir input[type="number"] {
        width: 100%;
        padding: 10px;
        font-size: 16px;
        border: 1px solid #A9A9F5;
        border-radius: 5px;
        margin-top: 10px; /* Adicionei um espaçamento superior para melhorar a aparência */
    }
        .video-basico{
            display:flex;
            justify-content:center;
...
.icones{
    ...
    .texto-ensino, .texto-ensino2, .conteudo-ensino2{
        display:none;
    }
    .caixa-contribuir{
        margin-top:-330px;
...
<body>
    ...
    <a class="logo-michael" href="index.php">
        ...
        <div class="video-meio">
            <div class="video">
                <video class="infantil-video" src="videos/infantil-video.mp4" autoplay loop muted></video>
            </div>
        </div>

      
       <div class="ensino-camp">
            <div class="titulo-ensino-en">
                <h1 class="titulo-ensino-2">Campanha Harmonia Infantil</h1>
            </div>
            <div class="ensino1">
             <div class="texto-ensino-basico">
                
                 <h1 class="texto-ensino">Harmonia Infantil: Dê Vida à Música nas Mãos das Crianças</h1>
                 <p class="conteudo-ensino">Na Michael Instrumentos, acreditamos que a música tem o poder de transformar vidas e enriquecer o espírito. É por isso que estamos entusiasmados em lançar a campanha "Harmonia Infantil" - um convite a todos que compartilham do amor pela música e da dedicação ao bem-estar das crianças.
                    Cada doação é uma nota de esperança, um acorde de generosidade. Através dessa campanha, você não apenas fornece instrumentos musicais, mas também promove o crescimento pessoal, o desenvolvimento da criatividade e a construção de habilidades para as crianças.</p>
                 </p>
             </div>
     
             <div class="video-campanha">
                 <video class="campanha-video" src="videos/video-campanha.mp4" alt="" autoplay muted loop >  
         </div>
         </div>
         <div class="ensino2">
             <div class="texto-ensino2-basico">
                         <h1 class="texto-ensino2">Explorando o Mundo da Música com Michael Instrumentos</h1>
                         <p class="conteudo-ensino2">
                         A música é uma linguagem universal que transcende barreiras e conecta pessoas de todas as idades. No entanto, quando se trata de crianças, a música desempenha um papel ainda mais especial. Elas são naturalmente curiosas, criativas e receptivas a sons e ritmos. É por isso que dar a elas a oportunidade de explorar o mundo da música é um presente inestimável.
                         </p>
                     </div>
                     <div class="video-campanha">
                 <video class="campanha-video" src="videos/Gui.mp4" alt="" autoplay muted loop >  
         </div>
        
        </div>
         
         <div class="caixa-contribuir">
            <h1>Contribua com a Campanha "Harmonia Infantil"</h1>
            <p class="p">Seja parte deste movimento para promover a música entre crianças e apoiar a Campanha "Harmonia Infantil". Cada doação é uma nota de esperança, um acorde de generosidade.</p>
            <p class="p">Escolha o valor que deseja contribuir:</p>

            <div class="form">
                <form action="" method="POST">
                <label for="valor_contribuicao">Valor da Contribuição:</label>
                <input type="number" name="valor_contribuicao" id="valor_contribuicao" min="1" required>
          ...
          <div class="container-caixas">
            ...
            <div class="caixa-1">
                <div class="wrapper">
                  <div class="card">
                    <div class="front">
                      <h1>GUITARRA INFANTIL MICHAEL </h1>
                      <p>Michael</p>
                    ...
                    <div class="right">
                      <h2>Guitarra</h2>
                      <ul>
                        <li class="lii">GM219N</li>
                        <li class="lii">ST JUNIOR</li>
                      </ul>
                      <button class="comprar">Comprar</button>
                    </div>
                  </div>
                  <div class="img-wrapper">
                       <img src='img/guitarra-infantil.png' alt=''>    
                  </div>
                </div> 
              </div>
              ...
              <div class="caixa-2">
                <div class="wrapper">
                  ...
                  <div class="img-wrapper">
                       <img src='img/guitarra-infantil-2.png' alt=''>    
                  </div>
                </div> 
              </div>
              ...
              <div class="caixa-3">
                <div class="wrapper">
                  ...
                  <div class="img-wrapper">
                       <img src='img/guitarra-infantil-3.png' alt=''>    
                  </div>
                </div> 
              </div>
              </div>
          ...
          <div class="container-caixas">
            ...
            <div class="caixa-4">
              <div class="wrapper">
                  <div class="card">
                    <div class="front">
                      <h1>BATERIA MICHAEL INFANTIL</h1>
                      <p>Michael</p>
                    ...
                    <div class="right">
                      <h2>BATERIA</h2>
                      <ul>
                        <li class="lii">MDMC5</li>
                        <li class="lii">WR (WINE RED)</li>
                      </ul>
                      <button class="comprar">Comprar</button>
                    </div>
                  </div>
                  <div class="img-wrapper">
                       <img src='img/bateria-infantil-1.png' alt=''>    
                  </div>
                </div> 
              </div>
                ...
                <div class="wrapper">
                  <div class="card">
                    ...
                    <div class="right">
                      ...
                      <ul>
                        <li class="lii">MDMC5</li>
                        <li class="lii">NA (Natural)</li>
                      </ul>
                      <button class="comprar">Comprar</button>
                    </div>
                  </div>
                  <div class="img-wrapper">
                       <img src='img/bateria-infantil-2.png' alt=''>    
                  </div>
                </div> 
              </div>
                ...
                <div class="wrapper">
                  <div class="card">
                    ...
                    <div class="right">
                      ...
                      <ul>
                        <li class="lii">MDMC5</li>
                        <li class="lii">BK (Black)</li>
                      </ul>
                      <button class="comprar">Comprar</button>
                    </div>
                  </div>
                  <div class="img-wrapper">
                       <img src='img/bateria-infantil-3.png' alt=''>    
                  </div>
                </div> 
              </div>
              </div>
...
function buscarProduto() {
    ...
    const videoGuita = document.querySelector(".infantil-video");
    const videoGuita2 = document.querySelector(".ensino-camp");
    ...
    produtos.forEach(produto => {
        ...
        if (videoGuita) {
            videoGuita.style.display = buscarInput ? "none" : "block";
        }

        if (videoGuita2) {
            videoGuita2.style.display = buscarInput ? "none" : "block";
        }
    });
}
...
document.getElementById("buscar-input").addEventListener("input", function () {
    if (this.value === "") {
        ...
        if (videoGuita2) {
            videoGuita2.style.display = "block";
        }
    }
});
